"""
PatentForge v0.2.2 — Architecture Diagram Generator
...
def gen_architecture():
    ...
    # Title
    ax.text(0.5, 0.95, 'PatentForge — System Architecture (v0.2.2)',
...
def gen_database_schema():
    ...
    ax.text(0.6, 0.96, 'PatentForge — Database Schema (v0.2.2)',
            ha='center', va='center', color=TEXT, fontsize=16, fontweight='bold')
...
def gen_docker_topology():
    ...
    # Note
    ax.text(0.05, 0.12, 'v0.2.2: frontend + backend + feasibility + postgres',
            color=MUTED, fontsize=8, fontstyle='italic')
...
if __name__ == '__main__':
    print('Generating PatentForge v0.2.2 diagrams...')
    gen_architecture()
    gen_data_flow()
    gen_user_journey()
    gen_database_schema()
