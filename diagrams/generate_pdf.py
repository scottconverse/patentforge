"""
PatentForge v0.2.2 — README-FULL.pdf Generator
...
class PatentForgePDF(FPDF):
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 8, 'PatentForge v0.2.2 - Patent Landscape Research Tool', align='L')
...
def generate():
    ...
    pdf.cell(0, 8, 'Version 0.2.2  |  March 2026', align='C', new_x='LMARGIN', new_y='NEXT')
    ...
    pdf.add_diagram('architecture.png', 'Figure 1: PatentForge System Architecture (v0.2.2)')
