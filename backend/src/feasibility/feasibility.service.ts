...
<p style="font-size: 0.8rem; color: #6b7280; line-height: 1.5; margin-top: 1rem;">
  <strong style="color: #9ca3af;">Disclaimer:</strong> This document was generated by PatentForge, an AI-powered research and preparation tool. It does not constitute legal advice, a patent opinion, or attorney services. The AI-generated analysis may contain errors or omissions. All findings should be independently verified by a registered patent attorney or patent agent before being relied upon for any decision. Always consult qualified legal counsel before making patent filing decisions.
</p>
</div>
</body>
</html>`;
  ...
  async getDocxBuffer(projectId: string): Promise<{ buffer: Buffer; filename: string }> {
    ...
    paragraphs.push(new Paragraph({
      children: [
        ...
        new TextRun({
          text: 'This document was generated by PatentForge, an AI-powered research and preparation tool. It does not constitute legal advice, a patent opinion, or attorney services. The AI-generated analysis may contain errors or omissions. All findings should be independently verified by a registered patent attorney or patent agent before being relied upon for any decision. Always consult qualified legal counsel before making patent filing decisions.',
          color: '6B7280',
          size: 16,
          font: 'Calibri',
        }),
