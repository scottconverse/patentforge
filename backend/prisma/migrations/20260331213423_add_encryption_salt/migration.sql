...
INSERT INTO "new_AppSettings" ("anthropicApiKey", "costCapUsd", "defaultModel", "exportPath", "id", "interStageDelaySeconds", "maxTokens", "researchModel", "usptoApiKey") SELECT "anthropicApiKey", "costCapUsd", "defaultModel", "exportPath", "id", "interStageDelaySeconds", "maxTokens", "researchModel", "usptoApiKey" FROM "AppSettings";
