...
|----------|----------|-------|
| **Windows** | [PatentForge-0.8.2-Setup.exe](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.8.2-Setup.exe) | Inno Setup installer (~100 MB) |
| **Mac (Beta)** | [PatentForge-0.8.2.dmg](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.8.2.dmg) | Drag to Applications (~100 MB) |
| **Linux (Beta)** | [PatentForge-0.8.2.AppImage](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.8.2.AppImage) | chmod +x and run (~120 MB) |
...
*Figure 1: System Architecture (v0.8.2) — 6 services + system tray + 3 external APIs*
