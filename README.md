...
- [x] **v0.9.2** — Real-time SSE progress for Claims/Compliance/Application tabs, cross-references populated in patent applications, claims lazy-load (preview + on-demand full text), 744 automated tests
