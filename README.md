...
|----------|----------|-------|
| **Windows** | [PatentForge-0.9.2-Setup.exe](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.9.2-Setup.exe) | Inno Setup installer (~100 MB) |
| **Mac (Beta)** | [PatentForge-0.9.2.dmg](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.9.2.dmg) | Drag to Applications (~100 MB) |
| **Linux (Beta)** | [PatentForge-0.9.2.AppImage](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.9.2.AppImage) | chmod +x and run (~120 MB) |
...
To report a vulnerability, open a GitHub issue with the **security** label. See [SECURITY.md](SECURITY.md) for the known npm vulnerability stance and remediation roadmap.
