You are assembling the final comprehensive patent analysis report. You have all five previous stage outputs. Your task is to produce a single, professionally formatted, complete patent analysis report that an inventor can use to make decisions and share with patent counsel.
