...
const optionalFields: { key: keyof InventionInput; label: string; placeholder?: string }[] = [
  ...
  { key: 'aiComponents', label: 'AI / ML Components', placeholder: 'Describe any AI or machine learning components...' },
  { key: 'threeDPrintComponents', label: '3D Printing / Physical Design Components', placeholder: 'Describe any physical or 3D printed components...' },
  { key: 'whatIsNovel', label: 'What I Believe Is Novel', placeholder: 'What makes this invention unique or innovative?' },
  { key: 'currentAlternatives', label: 'Current Alternatives / Prior Solutions', placeholder: 'Describe existing solutions or prior art you are aware of...' },
  { key: 'whatIsBuilt', label: 'What Has Been Built So Far', placeholder: 'Describe any prototypes, proofs-of-concept, or working implementations...' },
  { key: 'whatToProtect', label: 'What I Want Protected', placeholder: 'Describe the specific aspects you want patent protection for...' },
...
export default function InventionForm({ projectId, initialData, onSaved, onRunFeasibility }: InventionFormProps) {
  ...
  function buildPayload() {
    return {
      ...
      ...Object.fromEntries(
        optionalFields.map(f => [f.key, optionals[f.key]?.trim() || undefined])
      ),
    };
  }
