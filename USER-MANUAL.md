...
|----------|----------|------|
| **Windows** | [PatentForge-0.9.0-Setup.exe](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.9.0-Setup.exe) | ~100 MB |
| **Mac (Beta)** | [PatentForge-0.9.0.dmg](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.9.0.dmg) | ~100 MB |
| **Linux (Beta)** | [PatentForge-0.9.0.AppImage](https://github.com/scottconverse/patentforge/releases/latest/download/PatentForge-0.9.0.AppImage) | ~120 MB |
...
**Linux (Beta):** Download the `.AppImage` file. Make it executable (`chmod +x PatentForge-0.9.0.AppImage`) and run it. On some systems you may need to install FUSE first.
